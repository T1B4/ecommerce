...
class Posts extends Model {
    ...
    public function editPost($id, $titulo, $subtitulo, $cat, $texto)
    {
        $sql = $this->db->prepare("UPDATE posts SET post_titulo = :titulo, post_subtitulo = :subtitulo, post_cat = :cat, post_texto = :texto WHERE post_id = :id");
        $sql->bindValue(':id', $id);
        $sql->bindValue(':titulo', $titulo);
        $sql->bindValue(':subtitulo', $subtitulo);
        $sql->bindValue(':cat', $cat);
    ...
    {
        $sql = $this->db->prepare("DELETE FROM posts WHERE post_id = :id");
        $sql->bindValue(":id", $id);
        $sql->execute();
    ...
    public function getPostById($id) {
        ...
        $sql = $this->db->prepare("SELECT * FROM posts WHERE post_id = :id");
        $sql->setFetchMode(PDO::FETCH_ASSOC);
        $sql->bindValue(':id', $id);
        $sql->execute();
